								...
								<div class="table_wrapper_inner">
                                    ...
                                    <form action="<?php echo base_url()?>admin/cate/updatemn/<?php echo $list['cate_id']?>" method="post" name="sac" onsubmit="return check()" enctype="multipart/form-data">
                                         ...
                                         <div class="form_items">
                                        	...
                                        	<div class="form_items_right"><input name="cate_info" type="text" value="<?php echo $list['cate_info']; ?>" size="35"></div>
                                   		 </div>
                                         <div class="form_items">
                                         ...
                                         <div class="form_items">
                                        	...
                                        	<div class="form_items_right"><textarea name="cate_keys" cols="28" rows="5"><?php echo $list['cate_keys']; ?></textarea></div>
                                   		 </div>
                                         <div class="form_items">
                                    		<div class="form_items_left">SEO Description</div>
                                        	<div class="form_items_right"><textarea name="cate_description" cols="28" rows="5"><?php echo $list['cate_description']; ?></textarea></div>
                                   		 </div>
                                         <div class="form_items">
